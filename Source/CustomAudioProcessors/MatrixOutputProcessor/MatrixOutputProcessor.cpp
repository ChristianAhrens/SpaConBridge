 ...
 */
bool MatrixOutputProcessor::GetParameterChanged(const DataChangeParticipant& changeTarget, const DataChangeType& changeTypes)
{
 ...
 *			since the last time PopParameterChanged() was called.
 */
bool MatrixOutputProcessor::PopParameterChanged(const DataChangeParticipant& changeTarget, const DataChangeType& changeTypes)
{
 ...
 * @param changeTypes	Defines which parameter or property has been changed.
 */
void MatrixOutputProcessor::SetLastSourceForChangeType(const DataChangeParticipant& changeSource, const DataChangeType& changeTypes)
{
 ...
 */
const DataChangeParticipant MatrixOutputProcessor::GetParameterChangeSource(const DataChangeType& changeType)
{
