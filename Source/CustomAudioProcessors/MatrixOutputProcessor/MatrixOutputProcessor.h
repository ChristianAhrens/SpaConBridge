...
public:
	...
	void SetMatrixOutputId(DataChangeSource changeSource, MatrixOutputId MatrixOutputId);
	...
	void SetParameterValue(DataChangeSource changeSource, MatrixOutputParameterIndex paramIdx, float newValue);
