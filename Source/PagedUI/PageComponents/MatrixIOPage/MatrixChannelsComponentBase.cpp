 ...
 */
void MatrixChannelsComponentBase::timerCallback()
{
 ...
 */
void MatrixChannelsComponentBase::AddMessageData(MatrixChannelsComponentBaseSource logSourceType, RemoteObjectIdentifier Id, const RemoteObjectMessageData& msgData)
{
...
void MatrixChannelsComponentBase::paintCell(Graphics& g, int rowNumber, int columnId, int width, int height, bool rowIsSelected)
{
	...
	{
		auto logSource = static_cast<MatrixChannelsComponentBaseSource>(m_logEntries[mapIdx][SLC_LogSourceType].getIntValue());
 ...
 */
void MatrixChannelsComponentBase::SetShowDS100Traffic(bool show)
{
 ...
 */
String MatrixChannelsComponentBase::GetLogSourceName(MatrixChannelsComponentBaseSource logSourceType)
{
 ...
 */
const Colour MatrixChannelsComponentBase::GetLogSourceColour(MatrixChannelsComponentBaseSource logSourceType)
{
	switch (logSourceType)
	{
	case SLS_DiGiCo:
